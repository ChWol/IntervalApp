...
class LocalizationManager: ObservableObject {
    ...
    private let strings: [String: [AppLanguage: String]] = [
        ...
        "INTERVAL REVIEW & MIGRATION": [
            .english: "INTERVAL REVIEW & MIGRATION",
            .german: "INTERVALL-REVIEW & MIGRATION",
            .french: "REVUE D'INTERVALLE & MIGRATION",
            .spanish: "REVISIÓN DE INTERVALOS Y MIGRACIÓN",
            .portuguese: "REVISÃO DE INTERVALO E MIGRAÇÃO",
            .italian: "REVISIONE DELL'INTERVALLO E MIGRAZIONE",
            .arabic: "مراجعة الفترات الزمنية والترحيل",
            .chinese: "时间段审查与迁移",
            .japanese: "インターバル・レビュー＆移行",
            .korean: "기간별 검토 및 마이그레이션"
        ],
        "Manually start an interval review to reflect, reorganize, and plan your tasks:": [
            .english: "Manually start an interval review to reflect, reorganize, and plan your tasks:",
            .german: "Starte manuell ein Review, um deine Aufgaben zu reflektieren und zu planen:",
            .french: "Lancez manuellement une revue pour réfléchir et planifier vos tâches :",
            .spanish: "Inicia manualmente una revisión para reflexionar y planificar tus tareas:",
            .portuguese: "Inicie manualmente uma revisão para refletir e planejar suas tarefas:",
            .italian: "Avvia manualmente una revisione per riflettere e pianificare i tuoi compiti:",
            .arabic: "ابدأ يدويًا مراجعة لمراجعة مهامك وتنظيمها والتخطيط لها:",
            .chinese: "手动开始时间段审查以反思、重组并规划您的任务：",
            .japanese: "手動でインターバル・レビューを開始し、タスクの振り返りと計画を行います：",
            .korean: "수동으로 기간 검토를 시작하여 작업을 점검하고 계획하세요:"
        ],
        "Daily Review & Planning": [
            .english: "Daily Review & Planning",
            .german: "Tages-Review & Planung",
            .french: "Revue quotidienne & Planification",
            .spanish: "Revisión diaria y planificación",
            .portuguese: "Revisão diária e planejamento",
            .italian: "Revisione giornaliera e pianificazione",
            .arabic: "المراجعة اليومية والتخطيط",
            .chinese: "每日审查与规划",
            .japanese: "デイリー・レビュー＆計画",
            .korean: "일일 검토 및 계획"
        ],
        "Plan today's tasks from your 1 Week list": [
            .english: "Plan today's tasks from your 1 Week list",
            .german: "Plane die heutigen Aufgaben aus deiner 1-Woche-Liste",
            .french: "Planifiez les tâches du jour depuis votre liste 1 Semaine",
            .spanish: "Planifica las tareas de hoy desde tu lista de 1 Semana",
            .portuguese: "Planeje as tarefas de hoje a partir da lista de 1 Semana",
            .italian: "Pianifica i compiti di oggi dalla tua lista 1 Settimana",
            .arabic: "خطط لمهام اليوم من قائمة أسبوع واحد",
            .chinese: "从您的 1 周清单中规划今日任务",
            .japanese: "1週間リストから今日のタスクを計画する",
            .korean: "1주일 목록에서 오늘의 작업을 계획하세요"
        ],
        "Weekly Review & Planning": [
            .english: "Weekly Review & Planning",
            .german: "Wochen-Review & Planung",
            .french: "Revue hebdomadaire & Planification",
            .spanish: "Revisión semanal y planificación",
            .portuguese: "Revisão semanal e planejamento",
            .italian: "Revisione settimanale e pianificazione",
            .arabic: "المراجعة الأسبوعية والتخطيط",
            .chinese: "每周审查与规划",
            .japanese: "ウィークリー・レビュー＆計画",
            .korean: "주간 검토 및 계획"
        ],
        "Plan the upcoming week from your 1 Month list": [
            .english: "Plan the upcoming week from your 1 Month list",
            .german: "Plane die kommende Woche aus deiner 1-Monat-Liste",
            .french: "Planifiez la semaine à venir depuis votre liste 1 Mois",
            .spanish: "Planifica la próxima semana desde tu lista de 1 Mes",
            .portuguese: "Planeje a próxima semana a partir da lista de 1 Mês",
            .italian: "Pianifica la prossima settimana dalla tua lista 1 Mese",
            .arabic: "خطط للأسبوع القادم من قائمة شهر واحد",
            .chinese: "从您的 1 月清单中规划下周任务",
            .japanese: "1ヶ月リストから来週のタスクを計画する",
            .korean: "1개월 목록에서 다음 주 작업을 계획하세요"
        ],
        "Monthly Review & Realignment": [
            .english: "Monthly Review & Realignment",
            .german: "Monats-Review & Neuausrichtung",
            .french: "Revue mensuelle & Réalignement",
            .spanish: "Revisión mensual y reajuste",
            .portuguese: "Revisão mensal e realinhamento",
            .italian: "Revisione mensile e riallineamento",
            .arabic: "المراجعة الشهرية وإعادة التوجيه",
            .chinese: "每月审查与调整",
            .japanese: "マンスリー・レビュー＆再調整",
            .korean: "월간 검토 및 재조정"
        ],
        "Plan this month from your 1 Year goals": [
            .english: "Plan this month from your 1 Year goals",
            .german: "Plane diesen Monat aus deinen 1-Jahr-Zielen",
            .french: "Planifiez ce mois depuis vos objectifs 1 An",
            .spanish: "Planifica este mes desde tus metas de 1 Año",
            .portuguese: "Planeje este mês a partir de suas metas de 1 Ano",
            .italian: "Pianifica questo mese dai tuoi obiettivi di 1 Anno",
            .arabic: "خطط لهذا الشهر من أهداف عام واحد",
            .chinese: "从您的 1 年目标中规划本月任务",
            .japanese: "1年目標から今月のタスクを計画する",
            .korean: "1년 목표에서 이번 달 작업을 계획하세요"
        ],
        "Annual Goals & Reflection": [
            .english: "Annual Goals & Reflection",
            .german: "Jahresziele & Reflexion",
            .french: "Objectifs annuels & Réflexion",
            .spanish: "Metas anuales y reflexión",
            .portuguese: "Metas anuais e reflexão",
            .italian: "Obiettivi annuali e riflessione",
            .arabic: "الأهداف السنوية والتأمل",
            .chinese: "年度目标与反思",
            .japanese: "年間目標＆振り返り",
            .korean: "연간 목표 및 회고"
        ],
        "Review and set your long-term goals for the year": [
            .english: "Review and set your long-term goals for the year",
            .german: "Überprüfe und setze deine langfristigen Ziele für das Jahr",
            .french: "Passez en revue et définissez vos objectifs pour l'année",
            .spanish: "Revisa y establece tus metas a largo plazo para el año",
            .portuguese: "Revise e defina suas metas de longo prazo para o ano",
            .italian: "Rivedi e imposta i tuoi obiettivi a lungo termine per l'anno",
            .arabic: "راجع وحدد أهدافك طويلة المدى لهذا العام",
            .chinese: "审查并设定您全年的长期目标",
            .japanese: "1年間の長期目標を確認・設定する",
            .korean: "1년간의 장기 목표를 검토하고 설정하세요"
        ]
    ]
}

...
class LocalizationManager: ObservableObject {
    ...
    private let strings: [String: [AppLanguage: String]] = [
        ...
        "Skip onboarding": [.english: "Skip onboarding", .german: "Einführung überspringen"],
        "Skip tour": [.english: "Skip tour", .german: "Tour überspringen"],
        "Back": [.english: "Back", .german: "Zurück"],
        "Next": [.english: "Next", .german: "Weiter"],
        "Finish": [.english: "Finish", .german: "Fertig"],
        "Make space for what matters now.": [.english: "Make space for what matters now.", .german: "Schaffe Raum für das, was jetzt zählt."],
        "You can import later in Settings → Data & Import.": [.english: "You can import later in Settings → Data & Import.", .german: "Du kannst später unter Einstellungen → Daten & Import importieren."],
        "Choose a task": [.english: "Choose a task", .german: "Aufgabe auswählen"],
        "Migrate  /  Skip": [.english: "Migrate  /  Skip", .german: "Übernehmen  /  Überspringen"],
        "Example transition: choose a task, migrate, or skip": [.english: "Example transition: choose a task, migrate, or skip", .german: "Beispiel für einen Wechsel: Aufgabe auswählen, übernehmen oder überspringen"],
        "A home for every time horizon": [.english: "A home for every time horizon", .german: "Ein Platz für jeden Zeithorizont"],
        "Your plan runs from 1 Hour to 1 Year. Put what matters now at the top, and keep longer plans below.": [.english: "Your plan runs from 1 Hour to 1 Year. Put what matters now at the top, and keep longer plans below.", .german: "Dein Plan reicht von 1 Stunde bis 1 Jahr. Was jetzt wichtig ist, steht oben; langfristige Vorhaben weiter unten."],
        "Add and edit tasks": [.english: "Add and edit tasks", .german: "Aufgaben hinzufügen und bearbeiten"],
        "Use + beside an interval to add a task. Click or tap a task to edit its text whenever plans change.": [.english: "Use + beside an interval to add a task. Click or tap a task to edit its text whenever plans change.", .german: "Mit + neben einem Zeitraum fügst du eine Aufgabe hinzu. Klicke oder tippe darauf, um sie jederzeit zu bearbeiten."],
        "Move plans as they change": [.english: "Move plans as they change", .german: "Pläne verschieben"],
        "Drag tasks within an interval to reorder them, or into another interval to change when you plan to do them.": [.english: "Drag tasks within an interval to reorder them, or into another interval to change when you plan to do them.", .german: "Ziehe Aufgaben innerhalb eines Zeitraums, um sie neu anzuordnen, oder in einen anderen Zeitraum, wenn sich dein Plan ändert."],
        "Keep the longer view": [.english: "Keep the longer view", .german: "Den Überblick behalten"],
        "1 Week, 1 Month, and 1 Year give larger goals a home. Move an idea closer as it becomes something you can act on.": [.english: "1 Week, 1 Month, and 1 Year give larger goals a home. Move an idea closer as it becomes something you can act on.", .german: "1 Woche, 1 Monat und 1 Jahr geben größeren Zielen Platz. Verschiebe eine Idee nach oben, sobald du sie angehen kannst."],
        "Finish or remove a task": [.english: "Finish or remove a task", .german: "Aufgaben erledigen oder entfernen"],
        "Tick the dash when a task is done. Use × to move it to Recently Deleted. Below your lists you can restore a task, or clear it permanently.": [.english: "Tick the dash when a task is done. Use × to move it to Recently Deleted. Below your lists you can restore a task, or clear it permanently.", .german: "Markiere den Strich, wenn eine Aufgabe erledigt ist. Mit × verschiebst du sie zu Kürzlich gelöscht. Unter den Listen kannst du Aufgaben wiederherstellen oder endgültig löschen."],
        "Focus on just one thing": [.english: "Focus on just one thing", .german: "Konzentriere dich auf eine Sache"],
        "The viewfinder beside a task opens Deep Focus. The rest of the app fades away until you close it or press Escape.": [.english: "The viewfinder beside a task opens Deep Focus. The rest of the app fades away until you close it or press Escape.", .german: "Das Sucher-Symbol neben einer Aufgabe öffnet Deep Focus. Der Rest der App tritt zurück, bis du die Ansicht schließt oder Escape drückst."],
        "Plan each new interval": [.english: "Plan each new interval", .german: "Jeden neuen Zeitraum planen"],
        "At an hour, day, week, month, or year boundary, Interval asks which tasks should move into your next focus. Select what you want, or press Escape to skip. Unselected tasks stay where they are.": [.english: "At an hour, day, week, month, or year boundary, Interval asks which tasks should move into your next focus. Select what you want, or press Escape to skip. Unselected tasks stay where they are.", .german: "Beim Wechsel von Stunde, Tag, Woche, Monat oder Jahr fragt Interval, welche Aufgaben du mitnehmen möchtest. Wähle sie aus oder überspringe mit Escape. Nicht ausgewählte Aufgaben bleiben an ihrem Platz."],
        "Make room for habits": [.english: "Make room for habits", .german: "Platz für Gewohnheiten"],
        "Add a daily or weekly habit here. Tick it when done, postpone it for today, or drag it into 1 Hour when you want to focus on it.": [.english: "Add a daily or weekly habit here. Tick it when done, postpone it for today, or drag it into 1 Hour when you want to focus on it.", .german: "Füge hier eine tägliche oder wöchentliche Gewohnheit hinzu. Hake sie ab, verschiebe sie für heute oder ziehe sie in 1 Stunde, um dich darauf zu konzentrieren."],
        "See your rhythm": [.english: "See your rhythm", .german: "Deinen Rhythmus sehen"],
        "Habit Statistics shows streaks, yearly completions, and a calendar for each habit.": [.english: "Habit Statistics shows streaks, yearly completions, and a calendar for each habit.", .german: "Die Gewohnheitsstatistik zeigt Serien, Erledigungen im Jahr und einen Kalender für jede Gewohnheit."],
        "Keep flexible lists": [.english: "Keep flexible lists", .german: "Flexible Listen führen"],
        "Scratchpad is for notes and lists that do not need a time horizon. Create lists and items, then move an item into your main plan when it becomes actionable.": [.english: "Scratchpad is for notes and lists that do not need a time horizon. Create lists and items, then move an item into your main plan when it becomes actionable.", .german: "Im Scratchpad sammelst du Notizen und Listen ohne festen Zeitraum. Erstelle Listen und Einträge und verschiebe einen Eintrag in deinen Plan, sobald er ansteht."],
        "Share a list": [.english: "Share a list", .german: "Eine Liste teilen"],
        "Open a Scratchpad list and use its people button to share it. Shared lists stay separate from your interval tasks.": [.english: "Open a Scratchpad list and use its people button to share it. Shared lists stay separate from your interval tasks.", .german: "Öffne eine Scratchpad-Liste und teile sie über das Personen-Symbol. Geteilte Listen bleiben von deinen Aufgaben nach Zeiträumen getrennt."],
        "Find anything quickly": [.english: "Find anything quickly", .german: "Alles schnell finden"],
        "Search looks across intervals, habits, and lists. Press ⌘F or ⌘K to open it quickly.": [.english: "Search looks across intervals, habits, and lists. Press ⌘F or ⌘K to open it quickly.", .german: "Die Suche findet Aufgaben, Gewohnheiten und Listen. Mit ⌘F oder ⌘K öffnest du sie direkt."],
        "Search looks across intervals, habits, and lists. Tap the magnifying glass to find what you need.": [.english: "Search looks across intervals, habits, and lists. Tap the magnifying glass to find what you need.", .german: "Die Suche findet Aufgaben, Gewohnheiten und Listen. Tippe auf die Lupe, um etwas zu finden."],
        "Make Interval yours": [.english: "Make Interval yours", .german: "Interval anpassen"],
        "Settings holds language, habits, sound, notifications, and the start of your day and week. Your account also syncs your plans across signed-in devices.": [.english: "Settings holds language, habits, sound, notifications, and the start of your day and week. Your account also syncs your plans across signed-in devices.", .german: "In den Einstellungen findest du Sprache, Gewohnheiten, Ton, Mitteilungen und den Beginn deines Tages und deiner Woche. Dein Konto synchronisiert deine Pläne auf angemeldeten Geräten."],
        "Import whenever you like": [.english: "Import whenever you like", .german: "Jederzeit importieren"],
        "You can import from other apps later in Settings → Data & Import. You can also export a JSON backup here.": [.english: "You can import from other apps later in Settings → Data & Import. You can also export a JSON backup here.", .german: "Du kannst später unter Einstellungen → Daten & Import aus anderen Apps importieren und hier auch eine JSON-Sicherung exportieren."],
        "Stay on track anywhere": [.english: "Stay on track anywhere", .german: "Überall den Überblick behalten"],
        "Keep your 1 Hour tasks in the menu bar, choose whether Interval launches at login, and print or save your plan with ⌘P.": [.english: "Keep your 1 Hour tasks in the menu bar, choose whether Interval launches at login, and print or save your plan with ⌘P.", .german: "Zeige deine Aufgaben für 1 Stunde in der Menüleiste, starte Interval auf Wunsch bei der Anmeldung und drucke oder speichere deinen Plan mit ⌘P."],
        "Use Interval on your phone with widgets and, if enabled in Settings, Dynamic Island and Live Activities for your current hour.": [.english: "Use Interval on your phone with widgets and, if enabled in Settings, Dynamic Island and Live Activities for your current hour.", .german: "Nutze Interval auf dem iPhone mit Widgets und, wenn aktiviert, Dynamic Island und Live-Aktivitäten für deine aktuelle Stunde."],
        "You're ready": [.english: "You're ready", .german: "Du bist bereit"],
        "Start with one thing you want to do this hour. You can replay this tour any time from Settings.": [.english: "Start with one thing you want to do this hour. You can replay this tour any time from Settings.", .german: "Beginne mit einer Sache, die du in dieser Stunde erledigen möchtest. Du kannst diese Tour jederzeit in den Einstellungen erneut ansehen."],
        "DEEP FOCUS": [
            .english: "DEEP FOCUS", .german: "TIEFER FOKUS", .french: "CONCENTRATION", .spanish: "ENFOQUE PROFUNDO", .portuguese: "FOCO PROFUNDO", .italian: "FOCUS PROFONDO", .arabic: "تركيز عميق", .chinese: "深度专注", .japanese: "ディープフォーカス", .korean: "딥 포커스"
        ],
        "Add to 1 Hour": [
            .english: "Add to 1 Hour", .german: "Zu 1 Stunde hinzufügen", .french: "Ajouter à 1 heure", .spanish: "Añadir a 1 hora", .portuguese: "Adicionar a 1 hora", .italian: "Aggiungi a 1 ora", .arabic: "أضف إلى ساعة واحدة", .chinese: "添加到1小时", .japanese: "1時間に追加", .korean: "1시간에 추가"
        ],
        "No habits added yet. Click + New Habit to set daily or weekly routines.": [
            .english: "No habits added yet. Click + New Habit to set daily or weekly routines.", .german: "Noch keine Gewohnheiten. Klicke auf + Neue Gewohnheit, um tägliche oder wöchentliche Routinen anzulegen.", .french: "Aucune habitude. Cliquez sur + Nouvelle habitude pour créer une routine quotidienne ou hebdomadaire.", .spanish: "Aún no hay hábitos. Haz clic en + Nuevo hábito para crear rutinas diarias o semanales.", .portuguese: "Ainda não há hábitos. Clique em + Novo hábito para criar rotinas diárias ou semanais.", .italian: "Nessuna abitudine. Fai clic su + Nuova abitudine per creare routine giornaliere o settimanali.", .arabic: "لم تُضف عادات بعد. اضغط + عادة جديدة لإنشاء روتين يومي أو أسبوعي.", .chinese: "尚未添加习惯。点击“+ 新习惯”设置每日或每周例程。", .japanese: "習慣はまだありません。「+ 新しい習慣」から毎日または毎週のルーティンを作成できます。", .korean: "아직 습관이 없습니다. + 새 습관을 눌러 매일 또는 매주 반복할 습관을 만드세요."
        ],
        "Your data could not be opened": [
            .english: "Your data could not be opened", .german: "Deine Daten konnten nicht geöffnet werden", .french: "Vos données n’ont pas pu être ouvertes", .spanish: "No se pudieron abrir tus datos", .portuguese: "Não foi possível abrir os seus dados", .italian: "Impossibile aprire i tuoi dati", .arabic: "تعذر فتح بياناتك", .chinese: "无法打开你的数据", .japanese: "データを開けませんでした", .korean: "데이터를 열 수 없습니다"
        ],
        "Changes are still pending": [
            .english: "Changes are still pending", .german: "Änderungen sind noch nicht gespeichert", .french: "Les modifications sont encore en attente", .spanish: "Los cambios siguen pendientes", .portuguese: "As alterações ainda estão pendentes", .italian: "Le modifiche sono ancora in sospeso", .arabic: "لا تزال التغييرات معلّقة", .chinese: "更改仍在等待保存", .japanese: "変更はまだ保留中です", .korean: "변경 사항이 아직 보류 중입니다"
        ],
        "Try Again": [.english: "Try Again", .german: "Erneut versuchen", .french: "Réessayer", .spanish: "Reintentar", .portuguese: "Tentar novamente", .italian: "Riprova", .arabic: "حاول مرة أخرى", .chinese: "重试", .japanese: "再試行", .korean: "다시 시도"],
        "Keep Working": [.english: "Keep Working", .german: "Weiterarbeiten", .french: "Continuer", .spanish: "Seguir trabajando", .portuguese: "Continuar", .italian: "Continua", .arabic: "متابعة العمل", .chinese: "继续使用", .japanese: "作業を続ける", .korean: "계속 작업"],
        "Sync Setup": [.english: "Sync Setup", .german: "Synchronisierung einrichten", .french: "Configurer la synchronisation", .spanish: "Configurar sincronización", .portuguese: "Configurar sincronização", .italian: "Configura sincronizzazione", .arabic: "إعداد المزامنة", .chinese: "同步设置", .japanese: "同期設定", .korean: "동기화 설정"],
        "Start Sync": [.english: "Start Sync", .german: "Synchronisierung starten", .french: "Démarrer la synchronisation", .spanish: "Iniciar sincronización", .portuguese: "Iniciar sincronização", .italian: "Avvia sincronizzazione", .arabic: "بدء المزامنة", .chinese: "开始同步", .japanese: "同期を開始", .korean: "동기화 시작"],
        "Sync code (e.g. your name)": [.english: "Sync code (e.g. your name)", .german: "Synchronisierungscode (z. B. dein Name)", .french: "Code de synchronisation (p. ex. votre nom)", .spanish: "Código de sincronización (p. ej., tu nombre)", .portuguese: "Código de sincronização (ex.: o seu nome)", .italian: "Codice di sincronizzazione (es. il tuo nome)", .arabic: "رمز المزامنة (مثل اسمك)", .chinese: "同步代码（例如你的名字）", .japanese: "同期コード（例：名前）", .korean: "동기화 코드(예: 이름)"],
        "Enter a sync code to link your devices.\nUse the same code on your Mac and iPhone.": [
            .english: "Enter a sync code to link your devices.\nUse the same code on your Mac and iPhone.", .german: "Gib einen Synchronisierungscode ein, um deine Geräte zu verbinden.\nVerwende auf Mac und iPhone denselben Code.", .french: "Saisissez un code pour relier vos appareils.\nUtilisez le même code sur votre Mac et votre iPhone.", .spanish: "Introduce un código para vincular tus dispositivos.\nUsa el mismo código en tu Mac y iPhone.", .portuguese: "Introduza um código para ligar os dispositivos.\nUse o mesmo código no Mac e no iPhone.", .italian: "Inserisci un codice per collegare i dispositivi.\nUsa lo stesso codice su Mac e iPhone.", .arabic: "أدخل رمز مزامنة لربط أجهزتك.\nاستخدم الرمز نفسه على Mac وiPhone.", .chinese: "输入同步代码以连接设备。\n在 Mac 和 iPhone 上使用相同代码。", .japanese: "同期コードを入力してデバイスを連携します。\nMacとiPhoneで同じコードを使用してください。", .korean: "동기화 코드를 입력해 기기를 연결하세요.\nMac과 iPhone에서 같은 코드를 사용하세요."
        ],
        "SELECT TIME": [
            .english: "SELECT TIME",
